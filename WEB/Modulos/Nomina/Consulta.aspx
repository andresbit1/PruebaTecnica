<%@ Page Title="" Language="C#" MasterPageFile="~/M.Master" AutoEventWireup="true" CodeBehind="Consulta.aspx.cs" Inherits="WEB.Modulos.Nomina.Consulta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        <h6 class="border-bottom pb-2 mb-0"><b>Consulta</b></h6>
        <br />
        <div class="row g-3">
            <div class="col-sm-6">
            ...
            <asp:Button ID="BT_Buscar" OnClick="BT_Buscar_Click" runat="server" Text="Buscar" />
